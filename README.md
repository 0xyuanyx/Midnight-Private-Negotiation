...
> **2026-09-26 변경:** 이전 구조에서는 양측 제안 사다리가 항상 공개 기준가에서 만나, 공개 기준가를 아는 사람은 `SETTLED`만 보고 합의 가격을 알 수 있었습니다. 이제 Buyer와 Seller가 거래마다 새로 만든 임시 X25519 공유 비밀에서 비공개 가격 오프셋을 각자 계산하고, 두 사다리를 그만큼 함께 옮깁니다. 합의 가격은 거래마다 달라집니다. 오프셋은 한도와 무관하고, AI·Controller·Relay·로그·원장에 전달되지 않습니다.
